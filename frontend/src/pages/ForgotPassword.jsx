      ...
      >
        ...
        {sent ? (
          <div className="mt-8 text-center">
            ...
            <h1 className="mt-4 font-display text-xl font-medium text-ink dark:text-paper">Check your email</h1>
            <p className="mt-2 font-sans text-sm text-ink/50 dark:text-paper/50">
              If an account exists for <strong>{email}</strong>, we&apos;ve sent a password reset link.
            </p>
          </div>
        ) : (
          <>
            <h1 className="mt-6 font-display text-2xl font-medium text-ink dark:text-paper">Forgot password</h1>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              <div>
                ...
                <div className="relative">
                  <Mail className="absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-ink/30 dark:text-paper/30" />
                  <input
                    type="email"
                    value={email}
